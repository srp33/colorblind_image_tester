...
in_file_path = paste0(getwd(), "/colorblind_friendly_tester/uploads/", toString(args[1]), ".png")
out_file_path = paste0(getwd(), "/colorblind_friendly_tester/uploads/", toString(args[1]), ".png")
